...
//Define the structure called materialStruct
...
//creating a variable associated with the brass
    materialStruct *mat1;
    materialStruct *mat2;
...
void colorcube(void){
    ...
    mat1 = &brassMaterial;
    glMaterialfv(GL_FRONT_AND_BACK, GL_DIFFUSE, mat1->diff);
    glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, mat1->spec);
    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT, mat1->amb);
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, mat1->shine);

    mat2 = &silverMaterial;
    glMaterialfv(GL_FRONT_AND_BACK, GL_DIFFUSE, mat2->diff);
    glMaterialfv(GL_FRONT_AND_BACK, GL_SPECULAR, mat2->spec);
    glMaterialfv(GL_FRONT_AND_BACK, GL_AMBIENT, mat2->amb);
    glMaterialf(GL_FRONT_AND_BACK, GL_SHININESS, mat2->shine);
